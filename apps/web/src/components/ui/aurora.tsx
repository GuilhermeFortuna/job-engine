...
function hexStops(stops: string[]) {
...
export function Aurora({
  colorStops = ["#3D8BFF", "#7C5CBF", "#3D8BFF"],
  amplitude = 0.45,
  blend = 0.65,
  speed = 0.4,
  className,
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: hexStops(initial.colorStops) },
    ...
    const tick = (t: number) => {
      ...
      program.uniforms.uColorStops.value = hexStops(current.colorStops);
