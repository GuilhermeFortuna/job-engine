...
export function MagicCard(props: MagicCardProps) {
  ...
  // Hydration-safe theme read: next-themes is only reliable after mount.
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- client-only theme after hydration
    setMounted(true)
  }, [])
  ...
  return (
    ...
    >
      <div className="pointer-events-none bg-background absolute inset-px z-20 rounded-[inherit]" />
