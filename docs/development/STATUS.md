...
| ------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | --------- | ------------------------------------------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [BACK-014 Spec](specs/BACK-014-multi-profile-local-data-spec.md) / [Plan](plans/BACK-014-multi-profile-local-data-plan.md)                        | Backend  | `READY`   | None                                                          | Multi-profile applicant data and managed local assets      | Owner approval of Spec + Plan                                                           |
