...
| [BACK-015 Spec](specs/BACK-015-local-ai-runtime-spec.md) / [Plan](plans/BACK-015-local-ai-runtime-plan.md)                                        | Backend  | `REVIEW`  | BACK-014                                                      | Shared local-AI runtime, profile extraction, and readiness | Implementation evidence ready for review; DB/API integration tests need Postgres        |
| [BACK-016 Spec](specs/BACK-016-executable-application-targets-spec.md) / [Plan](plans/BACK-016-executable-application-targets-plan.md)            | Backend  | `REVIEW`  | CROSS-015                                                     | Executable application targets and ATS-native discovery    | Implementation complete; ready for review                                               |
