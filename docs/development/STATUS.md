...
| [BACK-017 Spec](specs/BACK-017-durable-application-batches-spec.md) / [Plan](plans/BACK-017-durable-application-batches-plan.md)                  | Backend  | `REVIEW`  | BACK-014, BACK-016                                            | Durable, frozen application batches                        | Implementation complete; API suite green (410 passed); awaiting independent review      |
| [FRONT-007 Spec](specs/FRONT-007-profile-onboarding-experience-spec.md) / [Plan](plans/FRONT-007-profile-onboarding-experience-plan.md)           | Frontend | `REVIEW`  | BACK-014, BACK-015                                            | Guided onboarding and Profile experience                   | Implementation complete; awaiting independent review                                |
