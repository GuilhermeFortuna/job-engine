...
| [CROSS-011](cross-repo/CROSS-011-auto-apply-outcome-lock.md)             | Cross    | `DONE`    | CROSS-009 evidence                                                                  | V2.1 outcome lock, drift reconciliation, and production-wiring audit      |
| [BACK-012](back/BACK-012-full-auto-authorization.md)                     | Backend  | `DONE`    | CROSS-011                                                                           | Explicit full-auto authorization and durable audit semantics              |
...
| [CROSS-014](cross-repo/CROSS-014-broad-application-platform-coverage.md) | Cross    | `REVIEW`  | CROSS-011, BACK-013, CROSS-012                                                      | Broad measured ATS and standard-form auto-apply coverage                  |
| [FRONT-006](front/FRONT-006-visible-automation-control-center.md)        | Frontend | `DONE`    | CROSS-011, BACK-012                                                                 | Visible automation control center, readiness, and launch UI               |
...
| [CROSS-014](cross-repo/CROSS-014-broad-application-platform-coverage.md) | Cursor agent      | `cursor/cross-014-platform-coverage-833f`   | 2026-08-21T09:00:00+00:00 | Remediation: web reason-code contract; reason-aware retain-on-pause; Ashby/SR hard veto; inventory 9 URLs/3 families (`cross-014-v5`) with eligible-denominator accounting; not acceptance-complete |
