...
| [FRONT-003](front/FRONT-003-job-details-resilience.md)         | Frontend | `READY`   | FRONT-002, BACK-007                               | Details, freshness, partial-failure, responsive, and accessibility states |
...
| [BACK-008](back/BACK-008-live-sync-streaming-api.md)           | Backend  | `BLOCKED` | CROSS-003, BACK-007                               | On-demand concurrent live sync and SSE streaming API                      |
| [FRONT-004](front/FRONT-004-interactive-live-search-ui.md)     | Frontend | `BLOCKED` | FRONT-003, BACK-008                               | Interactive live search and progress feedback UI                          |
| [CROSS-004](cross-repo/CROSS-004-live-search-acceptance.md)   | Cross    | `BLOCKED` | BACK-008, FRONT-004                               | Live search end-to-end integration and acceptance                         |
