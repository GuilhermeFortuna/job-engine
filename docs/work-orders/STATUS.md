...
| [CROSS-014](cross-repo/CROSS-014-broad-application-platform-coverage.md) | Cursor agent      | `cursor/cross-014-platform-coverage-833f`   | 2026-08-20T08:45:00+00:00 | Registry classify/lookalike veto, frozen inventory, option (c) measurability escalation; production smoke evidence pending after rebase onto CROSS-012 |
...
| 2026-08-20 | CROSS-014 | Owner approved option (b) inventory reporting: publish resolvable and unresolvable feed-listing counts separately; label percentage as "% of resolvable application URLs" only; escalate to option (c) when resolvable slice is vacuous. Frozen fixture inventory: 0 resolvable / 9 feed-listing URLs. | Project owner     |
