...
| [BACK-013](back/BACK-013-hybrid-ai-answer-provider.md)                   | Backend  | `READY`   | CROSS-011, BACK-011                                                                 | Hybrid local/Gemini grounded answer provider and evaluation gate          |
| [CROSS-012](cross-repo/CROSS-012-production-runtime-integration.md)      | Cross    | `READY`   | CROSS-011, BACK-012                                                                 | Production Electron automation runtime integration                        |
